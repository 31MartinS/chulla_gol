    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1rem', flexShrink: 0 }}>
        ...
        >
          ...
          <p style={{ margin: 0, lineHeight: 1.3, fontSize: '0.9rem' }}>¡Pon a prueba tu agilidad visual! Un balón transparente saltará rápidamente y desaparecerá. Su <strong>última posición</strong> indica hacia dónde irá el tiro. ¡Acomoda tus guantes durante el conteo para taparlo!</p>
        </motion.div>
