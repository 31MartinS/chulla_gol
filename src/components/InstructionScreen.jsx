  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '1rem', marginTop: '0.5rem', flexShrink: 0 }}>
        <h2 style={{ fontSize: '1.8rem', marginBottom: '0.5rem' }}>CÓMO JUGAR</h2>
        <p style={{ color: 'var(--color-accent-teal)', fontSize: '1.1rem', margin: 0 }}>Ponte los guantes y defiende tu arco</p>
      </div>

      <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginBottom: '1rem', flexShrink: 0 }}>
        <motion.div 
          initial={{ x: -20, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ delay: 0.2 }}
          style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', backgroundColor: 'var(--color-secondary)', padding: '0.8rem', borderRadius: '12px' }}
        >
      ...
      <motion.button 
        ...
        style={{ width: '100%', marginTop: 'auto', marginBottom: '1rem', flexShrink: 0 }}
      >
        ¡A Jugar!
      </motion.button>
    </motion.div>
